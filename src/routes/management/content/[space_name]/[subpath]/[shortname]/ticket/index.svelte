...
{#if $params.space_name && $params.subpath && $params.shortname}
  {#await Dmart.retrieve_entry(ResourceType.ticket, $params.space_name, $params.subpath.replaceAll("-", "/"), $params.shortname, true, true, $params.validate_schema === "false" ? false : true)}
